...
- Where does the data come from?
  - after running scripts: `node scripts/fetch-data.js`<br/> `data/playlist/` and `static/playlistitems/` will be generated by the api provided from [Youtube](https://developers.google.com/youtube/v3/getting-started)
